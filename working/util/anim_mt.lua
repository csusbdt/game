...
--[[
Animation variables:
	anim_name            -- string name of the animation, such as 'idleup', 'idledown', etc.
...
function anim_mt:draw() 
	...
	local frames = self.anims[self.anim_name]
...
function anim_mt:loop(anim_name) 
	self.anim_name = anim_name
	local frames = self.anims[anim_name]
